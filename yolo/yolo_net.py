...
class YOLONet(object):
    ...
    def __init__(self, is_training=True):
        ...
        self.output_size = (self.cell_size * self.cell_size) * (self.num_class + self.boxes_per_cell * 5)#735
        self.scale = 1.0 * self.image_size / self.cell_size#64
        self.boundary1 = self.cell_size * self.cell_size * self.num_class#49
        self.boundary2 = self.boundary1 + self.cell_size * self.cell_size * self.boxes_per_cell#147
        ...
        self.learning_rate = cfg.LEARNING_RATE#0.001
